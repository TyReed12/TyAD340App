...
/**
 * This class stores the different data in multiple String arrays. (titleYear, director
...
public class MovieList extends AppCompatActivity {
    ...
    String[] director = {
            "Thom Eberhardt", "Tommy Wirkola", "Michele Soavi", "Juan Carlos Fresnadillo",
            "Fred Dekker", "Chris Butler, Sam Fell", "Ruben Fleischer",
    ...
    public class CustomAdapter extends RecyclerView.Adapter<CustomAdapter.ViewHolder> {
            ...
            public ViewHolder(View v) {
                ...
                v.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent intent2 = new Intent(context, MovieView.class);
                        intent2.putExtra("Title", titleYear[posit][0]);
                        intent2.putExtra("Year", titleYear[posit][1]);
                        intent2.putExtra("Director", director[posit]);
        ...
        public void onBindViewHolder(ViewHolder holder, int position) {
            holder.mTitle.setText(titleYear[position][0]);
            holder.mDetail.setText(titleYear[position][1]);
        }

        // Return the size of your dataset
        @Override
        public int getItemCount() {
            return titleYear.length;
        }
    }
}